...
#uniaxialMaterial Concrete02 4 $fpc $ec0 [expr 0.0*$fpc] -0.007 0.1 $ft [expr 0.05*$Ec]; # unconfined concrete
#uniaxialMaterial Concrete02 5 $fpcc $ec0c [expr 0.2*$fpc] -0.010 0.1 $ft [expr 0.05*$Ecc]; # confined concrete
# ================================== FIN CONCRETE02 ======================================
