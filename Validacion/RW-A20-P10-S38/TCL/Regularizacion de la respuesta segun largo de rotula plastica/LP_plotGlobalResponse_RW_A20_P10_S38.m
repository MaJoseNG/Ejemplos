function [LatLoad_Test, LatDisp_Test, DFlexure_Test, DShear_Test, LatLoad, NodeLateralDisp] = LP_plotGlobalResponse_RW_A20_P10_S38(datafolder, directoryTest)
    %% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %BORRAR
...
%     plot(Uf_final,-LatLoad/1000)
    ...
    x = [610,319.96,319.96,319.96,319.96,319.96,228.6];
    h1 = sum(x);
